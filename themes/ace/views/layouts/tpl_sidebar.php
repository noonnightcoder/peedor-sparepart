...
$this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items' => array(
            ...
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('app', 'Retail')). '</span>', 'icon'=>'menu-icon fa fa-shopping-cart', 'url'=>Yii::app()->urlManager->createUrl('saleItem/index',array('sale_type'=>'R')),
