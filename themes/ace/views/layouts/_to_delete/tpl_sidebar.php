...
$this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items' => array(
        ...
        array('label' => '<span class="menu-text">' . strtoupper(Yii::t('menu', 'Inventory')) . '</span>',
            'icon' => 'menu-icon fa fa-desktop', 'url' => Yii::app()->urlManager->createUrl('receivingItem/index'), 'active' => $this->id . '/' . $this->action->id == 'receivingItem/index',
