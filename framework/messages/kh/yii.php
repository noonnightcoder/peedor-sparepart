...
return array (
  ...
  '{attribute} "{value}" has already been taken.' => '{attribute} "{value}" មានរួចហើយ',
  '{attribute} cannot be blank.' => '{attribute} មិនអាចទទេ',
  '{attribute} is invalid.' => '{attribute} មិនត្រឹមត្រូវ',
  '{attribute} is not a valid URL.' => '{attribute} URL មិនត្រឹមត្រូវ',
  ...
  '{attribute} must be a number.' => '{attribute} ត្រូវតែជាលេខ',
  '{attribute} must be an integer.' => '{attribute} ត្រូវតែជាចំនួនគត់',
  '{attribute} must be repeated exactly.' => '{attribute} ត្រូវតែដូចគ្នា',
  ...
  '{controller} cannot find the requested view "{view}".' => '{controller} មិនអាចរកឃើញឯកសារ "{view}" ',
