                        ...
                        <div class="col-xs-12 widget-container-col summary_header">
                            <div class="infobox infobox-green">
                                ...
                                <div class="infobox-data">
                                    <span class="infobox-data-number"><?php //echo $report->totalSaleSPD(); ?></span>
                                    <div class="infobox-content"><?php echo CHtml::link('Today\'s Sale', Yii::app()->createUrl("report/SaleDaily")); ?></div>
                                </div>
                            </div>
