            ...
            <tbody>
                ...
                <?php foreach(array_reverse($items,true) as $id=>$item): ?>
                    ...
                    <tr>                
                        ...
                        <td class="center"><?php echo TbHtml::encode(number_format($item['price_kh'],Common::getDecimalPlaceRS())); ?></td>
                ...
                <?php endforeach; ?> <!--/endforeach--> 
                    <tr class="gift_receipt_element">
                        ...
                        <td colspan="2" style='text-align:right;border-top:2px solid #000000;'> <?php echo number_format($sub_total_kh,Common::getDecimalPlaceRS(), '.', ','); ?></td>
                    </tr>
                     <tr class="gift_receipt_element">
                        <td colspan="<?php echo $colspan; ?>" style='text-align:right;'><?php echo $total_discount . '% ' . Yii::t('app', 'Discount'); ?></td>
                        <td colspan="2" style='text-align:right;'>
                            <?php echo  number_format($discount_amount,Common::getDecimalPlaceRS(), '.', ','); ?>
                        </td>
                    </tr>
                    ...
                    <tr class="gift_receipt_element">
                        ...
                        <td colspan="2" style='text-align:right;'>
                            ...
                            <?php echo number_format($total_kh,Common::getDecimalPlaceRS(), '.', ','); ?>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style='text-align:right'> <?php //echo Yii::app()->settings->get('site', 'currencySymbol') . number_format($payment['payment_amount'],Common::getDecimalPlaceRS(), '.', ','); ?></td>
                    </tr>
                    -->
                    <?php //endforeach;?>
