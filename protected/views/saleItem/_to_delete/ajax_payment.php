                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-info bigger-120"><?php echo Yii::app()->settings->get('site', 'currencySymbol') . number_format($sub_total/$gdiscount, Common::getDecimalPlace(), '.', ','); ?></span></td>
                        </tr>
                        <?php } ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-important bigger-120"><?php echo Yii::app()->settings->get('site', 'currencySymbol') . number_format($total, Common::getDecimalPlace(), '.', ','); ?><span></td>
                        </tr>
                        <tr>
