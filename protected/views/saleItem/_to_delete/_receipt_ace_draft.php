                    ...
                    <table class="table table-striped table-bordered" id="receipt_items">
                        ...
                        <?php foreach(array_reverse($items,true) as $id=>$item): ?>
                            <?php
                                   ...
                                   if ($discount_symbol=='$') {
                                       $total_item=number_format($item['price']*$item['quantity']-$discount_amount,Common::getDecimalPlace());
                                   } else {
                                       $total_item=number_format($item['price']*$item['quantity']-$item['price']*$item['quantity']*$discount_amount/100,Common::getDecimalPlace());
                                   }
                            ?>
                            <tr>
                                <td class="center"><?php echo TbHtml::encode($i); ?></td>
                                <td><?php echo TbHtml::encode($item['name']); ?></td>
                                <td><?php echo TbHtml::encode(number_format($item['price'],Common::getDecimalPlace())); ?></td>
                        ...
                        <?php if (Yii::app()->settings->get('system','discount')=='hidden') { ?> 
                            <tr>
                                ...
                                <td colspan="2" style='text-align:right'><?php echo TbHtml::b(number_format($qtytotal,Common::getDecimalPlace(), '.', ',')); ?></td>
                            </tr>

                            <tr>
                                <td colspan="4" style='text-align:right;'><?php echo TbHtml::b(Yii::t('app','Total')); ?></td>
                                <td colspan="2" style='text-align:right'><?php echo TbHtml::b(Yii::app()->settings->get('site', 'currencySymbol') .number_format($total,Common::getDecimalPlace(), '.', ',')); ?></td>
                            </tr>
                            ...
                            <?php foreach($payments as $payment_id=>$payment): ?> 
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style='text-align:right;'><?php echo TbHtml::b(Yii::app()->settings->get('site', 'currencySymbol') .number_format($payment['payment_amount'],Common::getDecimalPlace(), '.', ',')); ?></td>
                                </tr>
                            <?php endforeach;?>

                            <tr>
                                <td colspan="4" style='text-align:right;'><?php echo TbHtml::b(Yii::t('app','Change Due')); ?></td>
                                <td colspan="2" style='text-align:right;'><?php echo TbHtml::b(Yii::app()->settings->get('site', 'currencySymbol') .number_format($amount_change,Common::getDecimalPlace(), '.', ',')); ?></td>
                            </tr>    
