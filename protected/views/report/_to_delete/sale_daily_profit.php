	...
	'columns'=>array(
		array('name'=>'date_report',
                ...
                array('name'=>'sub_total',
                      ...
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol')  . number_format($report->saleDailyProfitTotals()[0],Common::getDecimalPlace(), ".", ","),
		...
		array('name'=>'profit',
                      ...
                      'footer'=>Yii::app()->settings->get('site', 'currencySymbol')  . number_format($report->saleDailyProfitTotals()[2],Common::getDecimalPlace(), ".", ","),
                      'footerHtmlOptions'=>array('style' => 'text-align: right;'),
                ),
                array('name'=>'margin',
