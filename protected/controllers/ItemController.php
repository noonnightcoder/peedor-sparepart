                ...
                if ($model->validate()) {
                    ...
                    try {
                        if ($model->save()) {
                            ...
                            //$item_id,$employee_id,$rev_quantity,$trans_date,$remarks,$trans_qty,$qty_b4_trans,$qty_af_trans

                            //Saving to inventory
                            Receiving::model()->saveInventory($model->id,$employee_id,$inv_quantity,$trans_date,'Update Item',$inv_quantity,$qty_in_stock,$new_quantity);
