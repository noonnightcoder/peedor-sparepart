...
class SaleItem extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('sale_id, item_id, line, currency_code', 'numerical', 'integerOnly' => true),
            array('quantity, cost_price, unit_price, price, discount_amount, discount,total_discount,rate', 'numerical'),
            array('description, discount_type', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('sale_id, item_id, currency_code, description, line, quantity, cost_price, unit_price, price, discount_amount, discount_type, total_discount', 'safe', 'on' => 'search'),
        );
    }
